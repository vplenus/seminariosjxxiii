				...
				<li>
					<a href="#v-home" data-toggle="tab">
						...
						<?php if ($active_sms_service == 'clickatell'):?>  
							<span class="badge badge-success"><?php echo ('Ativo');?></span>
						<?php endif;?>
					</a>
				</li>
				<li>
			...
			<div class="tab-content">
				...
				<div class="tab-pane" id="v-home">
					<?php echo form_open(base_url() . 'index.php?admin/sms_settings/clickatell' , 
						array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
						<div class="form-group">
	                      <label  class="col-sm-3 control-label"><?php echo ('Nome do usuário Clickatell');?></label>
	                      	<div class="col-sm-5">
	                  	...
	                  	<div class="form-group">
	                        <label  class="col-sm-3 control-label"><?php echo ('Senha Clickatell');?></label>
	                        <div class="col-sm-5">
	                    ...
	                    <div class="form-group">
	                      <label  class="col-sm-3 control-label"><?php echo ('ID da API Clickatell');?></label>
	                        <div class="col-sm-5">
				...
				<div class="tab-pane" id="v-profile">
					<?php echo form_open(base_url() . 'index.php?admin/sms_settings/twilio' , 
						array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
						<div class="form-group">
	                      <label  class="col-sm-3 control-label"><?php echo ('Conta Twilio');?> SID</label>
	                      	<div class="col-sm-5">
	                  	...
	                  	<div class="form-group">
	                        <label  class="col-sm-3 control-label"><?php echo ('Token de autenticação');?></label>
	                        <div class="col-sm-5">
	                    ...
	                    <div class="form-group">
	                      <label  class="col-sm-3 control-label"><?php echo ('Número de telefone registrado');?></label>
	                        <div class="col-sm-5">
