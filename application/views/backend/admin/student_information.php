        ...
        <ul class="nav nav-tabs bordered">
            <li class="active">
                <a href="#home" data-toggle="tab">
                    ...
                    <span class="hidden-xs"><?php echo ('Todos os alunos');?></span>
                </a>
            </li>
        <?php 
        ...
        ?>
            <li>
                <a href="#<?php echo $row['section_id'];?>" data-toggle="tab">
                    ...
                    <span class="hidden-xs"><?php echo ('Seção');?> <?php echo $row['name'];?> ( <?php echo $row['nick_name'];?> )</span>
                </a>
            </li>
        <?php endforeach;?>
        <?php endif;?>
