...
<center>
    ...
    <div id="invoice_print">
        <table width="100%" border="0">
            <tr>
                <td align="right">
                    <h5><?php echo ('Dados de criação'); ?> : <?php echo date('d M,Y', $row['creation_timestamp']);?></h5>
                    <h5><?php echo ('Título'); ?> : <?php echo $row['title'];?></h5>
                    <h5><?php echo ('Descrição'); ?> : <?php echo $row['description'];?></h5>
        ...
        <table width="100%" border="0">    
            <tr>
                <td align="left"><h4><?php echo ('Pagamento para'); ?> </h4></td>
                <td align="right"><h4><?php echo ('projeto de lei para'); ?> </h4></td>
            </tr>
        ...
        <table width="100%" border="0">    
            <tr>
                <td align="right" width="80%"><?php echo ('Montante total'); ?> :</td>
                <td align="right">$<?php echo $row['amount']; ?></td>
            </tr>
            <tr>
                <td align="right" width="80%"><h4><?php echo ('Quantidade paga'); ?> :</h4></td>
                <td align="right"><h4>$<?php echo $row['amount_paid']; ?></h4></td>
            </tr>
            <?php if ($row['due'] != 0):?>
            <tr>
                <td align="right" width="80%"><h4><?php echo ('Devido'); ?> :</h4></td>
