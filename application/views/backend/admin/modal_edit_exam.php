		...
		<div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="padded">
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="name" value="<?php echo $row['name'];?>" data-validate="required" data-message-required="<?php echo ('Valor obrigatório');?>"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-5">
                      <button type="submit" class="btn btn-info"><?php echo ('Editar_exame');?></button>
                    </div>
                </div>
            </form>
            </div>
