		...
		<ul class="nav nav-tabs bordered">
			...
			<li class="<?php if(!isset($edit_profile))echo 'active';?>">
            	<a href="#list" data-toggle="tab"><i class="entypo-menu"></i> 
					<?php echo ('Lista de idiomas');?>
                    	</a></li>
			<li>
            	<a href="#add" data-toggle="tab"><i class="entypo-plus-circled"></i>
					<?php echo ('Adicionar frase');?>
                    	</a></li>
			<li class="">
            	<a href="#add_lang" data-toggle="tab"><i class="entypo-plus-circled"></i> 
					<?php echo ('Adicionar idioma');?>
                    	</a></li>
		</ul>
    	<!------CONTROL TABS END------>
		...
		<div class="tab-content">
			...
			<div class="tab-pane active" id="edit" style="padding: 5px">
                <div class="">
                        ...
                        <input type="submit" value="<?php echo ('Frase de atualização');?>" onClick="document.getElementById('phrase_form').submit();" class="btn btn-blue"/>	
                        <?php
						echo form_close();
						?>
            ...
            <div class="tab-pane <?php if(!isset($edit_profile))echo 'active';?>" id="list">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-hover table-striped">
                	<thead>
                    	<tr>
                        	<th><?php echo ('Linguagem');?></th>
                        	<th><?php echo ('Opção');?></th>
                        </tr>
                    </thead>
                    <tbody>
                    	<?php
                    	...
                    	<tr>
                        	...
                        	<td>
                            	...
                            	<a href="<?php echo base_url();?>index.php?admin/manage_language/delete_language/<?php echo $field;?>"
                                	rel="tooltip" data-placement="top" data-original-title="<?php echo ('Excluir idioma');?>" class="btn btn-gray" onclick="return confirm('Delete Language ?');">
                    ...
                    <?php echo form_open(base_url() . 'index.php?admin/manage_language/add_phrase/' , array('class' => 'form-horizontal form-groups-bordered validate'));?>
                        <div class="padded">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="phrase" data-validate="required" data-message-required="<?php echo ('Valor obrigatório');?>"/>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                              <div class="col-sm-offset-3 col-sm-5">
                                  <button type="submit" class="btn btn-info"><?php echo ('Adicionar frase');?></button>
                              </div>
							</div>
                    <?php echo form_close();?>                
                </div>                
                    ...
                    <?php echo form_open(base_url() . 'index.php?admin/manage_language/add_language/' , array('class' => 'form-horizontal form-groups-bordered validate'));?>
                        <div class="padded">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="language" data-validate="required" data-message-required="<?php echo ('Valor obrigatório');?>"/>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                              <div class="col-sm-offset-3 col-sm-5">
                                  <button type="submit" class="btn btn-info"><?php echo ('Adicionar idioma');?></button>
                              </div>
							</div>
                    <?php echo form_close();?> 
                </div>
