    	...
    	<!------CONTROL TABS END----->
            ...
            <div class="tab-pane  <?php if(!isset($edit_data) && !isset($personal_profile) && !isset($academic_result) )echo 'active';?>" id="list">
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="table table-bordered table-hover table-striped">
                	<tr>
                        <td><?php echo ('Selecione a prova');?></td>
                        <td><?php echo ('Selecione a matéria');?></td>
                        <td>&nbsp;</td>
                	</tr>
                	<tr>
                        <td>
                        	<select name="exam_id" class="form-control"  style="float:left;">
                                <option value=""><?php echo ('Selecione uma prova');?></option>
                                <?php 
                        ...
                        <td>
                        	<!-----SELECT SUBJECT ACCORDING TO SELECTED CLASS-------->
                                <select name="subject_id" class="form-control" >
                                    <option value=""><?php echo ('Selecione a matéria');?></option>
                                    <?php 
