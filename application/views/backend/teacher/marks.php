    	...
    	<!------CONTROL TABS END------>
            ...
            <div class="tab-pane  <?php if(!isset($edit_data) && !isset($personal_profile) && !isset($academic_result) )echo 'active';?>" id="list">
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="table table-bordered table-hover table-striped">
                	<tr>
                        <td><?php echo ('Selecione o exame');?></td>
                        <td><?php echo ('Selecione a turma');?></td>
                        <td><?php echo ('Selecione o assunto');?></td>
                        <td>&nbsp;</td>
                	</tr>
                	<tr>
                        <td>
                        	<select name="exam_id" class="form-control"  style="float:left;">
                                <option value=""><?php echo ('Selecione um exame');?></option>
                                <?php 
                                ...
                                ?>
                                    <option value="<?php echo $row['exam_id'];?>"
                                        <?php if($exam_id == $row['exam_id'])echo 'selected';?>>
                                            <?php echo ('Turma');?> <?php echo $row['name'];?></option>
                                <?php
                                endforeach;
                                ?>
                            </select>
                        ...
                        <td>
                        	<select name="class_id" class="form-control"  onchange="show_subjects(this.value)"  style="float:left;">
                                <option value=""><?php echo ('Selecione uma aula');?></option>
                                <?php 
                        ...
                        <td>
                    		...
                    		<input type="submit" value="<?php echo ('Gerenciar marcas');?>" class="btn btn-info" />
                        </td>
                	</tr>
                </table>
                </form>
                ...
                <table class="table table-bordered table-hover table-striped" >
                    <thead>
                        <tr>
                            ...
                            <td><?php echo ('Marca obtida');?>(out of 100)</td>
                            <td><?php echo ('Comente');?></td>
                            <td></td>
                        </tr>
                    </thead>
                    <tbody>
