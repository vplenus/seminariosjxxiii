<hr />
    <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-hover table-striped">
        <thead>
            <tr>
                <th><?php echo ('Selecione um dado');?></th>
                <th><?php echo ('Selecione o mês');?></th>
                <th><?php echo ('Selecione o ano');?></th>
                <th><?php echo ('Selecione a turma');?></th>
                <th><?php echo ('Selecione um dado');?></th>
           </tr>
       </thead>
        <tbody>
            <form method="post" action="<?php echo base_url();?>index.php?teacher/attendance_selector" class="form">
                <tr class="gradeA">
                    ...
                    <td align="center"><input type="submit" value="<?php echo ('Gerenciar presença');?>" class="btn btn-info"/></td>
                </tr>
            </form>
        </tbody>
    </table>
