            ...
            <div class="tab-pane box active" id="list">
                ...
                <table class="table table-bordered table-hover table-striped datatable" id="table_export">
                	<thead>
                		<tr>
                    		<th><div>#</div></th>
                    		<th><div><?php echo ('Nome Turma');?></div></th>
                    		<th><div><?php echo ('Nome numérico');?></div></th>
                    		<th><div><?php echo ('Professor');?></div></th>
                ...
                <div class="box-content">
                	<?php echo form_open('teacher/classes/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        <div class="padded">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo ('Nome Numérico');?></label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="name_numeric"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo ('Professor');?></label>
                                <div class="col-sm-5">
                        ...
                        <div class="form-group">
                              <div class="col-sm-offset-3 col-sm-5">
                                  <button type="submit" class="btn btn-info"><?php echo ('Adicionar Turma');?></button>
                              </div>
							</div>
                    </form>                
                </div>                
