...
class Admin extends CI_Controller
{
	...
	function student_add()
	{
		...
		$page_data['page_title'] = 'Add Aluno';
		$this->load->view('backend/index', $page_data);
	}
	...
	function acd_session($param1 = '', $param2 = '')
    {
		...
		$page_data['page_title'] = 'Ano Letivo';
        $this->load->view('backend/index', $page_data);
    }
	...
	/*	if($_FILES['userfile']['userfile'] != '') {
		...
		$page_data['page_title'] = 'Admissão online';
        $this->load->view('backend/index', $page_data);
    }
	...
	function student_bulk_add($param1 = '')
	{
		...
		$page_data['page_title'] = 'Add em massa';
		$this->load->view('backend/index', $page_data);
	}
	...
	function student_information($class_id = '')
	{
		...
		$page_data['page_title'] 	= 'Informação dos alunos'. " - ".get_phrase('class')." : ".
	...
	function student_marksheet($class_id = '')
	{
		...
		$page_data['page_title'] 	= 'Folha de avaliação do aluno'. " - ".get_phrase('class')." : ".
											$this->crud_model->get_class_name($class_id);
		$page_data['class_id'] 	= $class_id;
		$this->load->view('backend/index', $page_data);
	}
    ...
    function teacher($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = 'Gerenciar Professor';
        $this->load->view('backend/index', $page_data);
    }
    ...
    function subject($param1 = '', $param2 = '' , $param3 = '')
    {
        ...
        $page_data['page_title'] = 'Gerenciar Matéria';
        $this->load->view('backend/index', $page_data);
    }
    ...
    function classes($param1 = '', $param2 = '')
    {
        ...
        $page_data['page_title'] = 'Gerenciar Aula';
        $this->load->view('backend/index', $page_data);
    }
    ...
    function section($class_id = '')
    {
        ...
        $page_data['page_title'] = 'Gerenciar Sessão';
        $page_data['class_id']   = $class_id;
        $this->load->view('backend/index', $page_data);    
    }
    ...
    function exam($param1 = '', $param2 = '' , $param3 = '')
    {
        ...
        $page_data['page_title'] = 'Gerenciar Provas';
        $this->load->view('backend/index', $page_data);
    }
    ...
    function marks($exam_id = '', $class_id = '', $subject_id = '')
    {
        ...
        $page_data['page_title'] = 'Gerenciar Notas de prova';
        $this->load->view('backend/index', $page_data);
    }
    ...
    function grade($param1 = '', $param2 = '')
    {
        ...
        $page_data['page_title'] = 'Gerenciar Turma';
        $this->load->view('backend/index', $page_data);
    }
    ...
    function class_routine($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = 'Cronograma';
        $this->load->view('backend/index', $page_data);
    }
	...
	function manage_attendance($date='',$month='',$year='',$class_id='')
	{
        ...
        $page_data['page_title'] =	'Gerenciar Frequência';
		$this->load->view('backend/index', $page_data);
	}
    ...
    function invoice($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = 'Gerenciar Despesa/Entrada';
    ...
    function expense_category($param1 = '' , $param2 = '')
    {
        ...
        $page_data['page_title'] = 'Categoria de Despesa';
        $this->load->view('backend/index', $page_data);
    }
    ...
    function book($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = 'Gerenciar Livros da Biblioteca';
        $this->load->view('backend/index', $page_data);
    ...
    function transport($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = 'Gereciar Pastoral';
        $this->load->view('backend/index', $page_data);
    ...
    function dormitory($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title']  = 'Gerenciar Dormitório';
        $this->load->view('backend/index', $page_data);
    ...
    function noticeboard($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = 'Gerenciar Noticias';
    ...
    function message($param1 = 'message_home', $param2 = '', $param3 = '') {
        ...
        $page_data['page_title']                = 'Mensagem Privada';
        $this->load->view('backend/index', $page_data);
    }
    ...
    function system_settings($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = 'Configuração do Sistema';
    ...
    function sms_settings($param1 = '' , $param2 = '')
    {
        ...
        $page_data['page_title'] = 'Configuração de SMS';
        $page_data['settings']   = $this->db->get('settings')->result_array();
        $this->load->view('backend/index', $page_data);
    }
    ...
    function manage_language($param1 = '', $param2 = '', $param3 = '')
    {
		...
		$page_data['page_title']       = 'Gerenciar Idioma';
    ...
    function backup_restore($operation = '', $type = '')
    {
        ...
        $page_data['page_title'] = 'Gerenciar Restauração de Backup';
        $this->load->view('backend/index', $page_data);
    }
